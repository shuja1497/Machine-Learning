...
if not data_collection:
	...
	all_data = data.reshape((20, -1)) # reshapes to (20 12288)
	#print all_data.shape
	train_data = np.zeros((20, all_data.shape[1]+1))
	train_data[:, :-1] = all_data
	train_data[:, -1] = 1# for face_02
	train_data[:10, -1] = 2 # for face_01
...
while True:
	...
	for (x,y,w,h) in faces:
		...
		if data_collection:
			...
			cv2.putText(fr, labels[out], (x, y), font,3, (255, 255, 0), 5)
			# print 'Prediction:', 
